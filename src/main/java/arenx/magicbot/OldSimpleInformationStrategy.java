...
public class OldSimpleInformationStrategy implements OldStrategy{

	private static Logger logger = LoggerFactory.getLogger(OldSimpleInformationStrategy.class);
	private PokemonGo go;

	public OldSimpleInformationStrategy(PokemonGo go){
		this.go=go;
	}
